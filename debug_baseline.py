...
class baseline_solver:
    ...
    def __init__(self,full_prob,OPT_do_ILP,OPT_use_psi,all_valid_edges,all_invalid_edges,default_primal_solution):
        self.default_primal_solution=default_primal_solution
    ...
    def check_solution_feasibility(self):
        ...
        dict_var_name_2_obj=self.dict_var_name_2_obj
        dict_var_con_2_lhs_exog=self.dict_var_con_2_lhs_exog#self.dict_ineq_var_con_lhs
        dict_con_name_2_LB=self.dict_con_name_2_LB#self.dict_ineq_con_name_2_rhs
        dict_var_con_2_lhs_eq=self.dict_var_con_2_lhs_eq
        dict_con_name_2_eq=self.dict_con_name_2_eq#self.dict_eq_con_name_2_rhs
        """
