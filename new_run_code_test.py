...
option_use="normal"
option_use="baseline"
my_options_possibilities=["normal","baseline","no_ub_use_remove"]
for option_use in my_options_possibilities:
    ...
    if option_use=="baseline":
        params_prempt=dict()
        params_prempt['run_baseline']=1
        params_prempt['do_ilp']=0
        params_prempt['max_iterations_loop_compress_project']=1


    my_json_input_path="../mid_jnk"
    data_fold='data/'
    output_file_fold='../NewResults/'+dataSetUse+'_numCust_'+str(num_cust_use)+'/'+option_use+'/'
    param_file_path='params_WW/params_XP/'+dataSetUse+'.json'
