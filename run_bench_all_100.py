...
file_set='r100'
if file_set=='r100':
    param_file_path='my_param_fold/my_params_100_r_100.json'
...
if file_set=='rc100':
    param_file_path='my_param_fold/my_params_100_rc_100.json'
...
if file_set=='c100':
    param_file_path='my_param_fold/my_params_100_c_100.json'
...
if file_set=='rc200':
    ...
    param_file_path='my_param_fold/my_params_100_rc_200.json'
...
if file_set=='r200':
    ...
    param_file_path='my_param_fold/my_params_100_r_200.json'
...
if file_set=='c200':
    ...
    param_file_path='my_param_fold/my_params_100_c_200.json'
...
in_fold="data/"
#out_fold="../ALL_JSON_BIG/out_R100_100_yes_delta/"
#out_fold="../ALL_JSON_BIG/out_R100_100_no_reset_yes_reset_each_end/"
out_fold="../All_100/"
