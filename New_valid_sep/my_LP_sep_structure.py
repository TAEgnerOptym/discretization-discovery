...
class my_LP_sep_structure:
    ...
    def make_benders_cut(self):
        ...
        for con_name in self.lp_dual_solution:
            dual_val=self.lp_dual_solution[con_name]
            #if abs(dual_val)>0.001 and con_name in self.dict_con_name_2_eq: #and con_name.startswith('flow_')==False:               
            #    print(con_name+'   '+str(dual_val))
                #con_name_matches = {
                #    v: val
                ...
                #print('dual_val')
                #print(dual_val)
                #print('self.dict_con_name_2_eq')
                #print(self.dict_con_name_2_eq[con_name])
                #var_name_matches2 = {
                #    c: val
                #    for (v, c), val in self.dict_var_con_2_lhs_exog.items()
                #    if v == 'SLACK_Neg_(1, frozenset())'
                #}
                #print('var_name_matches2')
                #print(var_name_matches2)
                #print('objecctive')
#                print(self.dict_var_2_obj['SLACK_Neg_(1, frozenset())'])
#                print('self.lp_primal_solution[LACK_Neg_(1, frozenset())]')
                #print(self.out_solution['primal_solution']['SLACK_Neg_(1, frozenset())'])
                #input('---')
             #   if con_name.startswith('Conshould')==True:
             #       input('big here look')
#        input('---')
        for (con_name,var_name) in self.con_name_xuv_2_benders_contrib:
            ...
            #if con_name.startswith('match')==False:
            #    print('con_name')
            #    print(con_name)
             #   input('Found one')
