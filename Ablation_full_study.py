...
if option_use=="graphs_offCutsOn":
    ...
    params_prempt['use_ng']=False
    params_prempt['use_time_graph']=False
    params_prempt['use_dem_graph']=True
    params_prempt['dem_step_sz']=10000
...
if file_class_use=="C100":

    param_fold='params_WW/params_c100_100_UB_given_cut_and_sol/'
    out_fold_path="../WillRezAbl/C100_100_cust/"+out_fold_path_portion_ablation_name
